...
public class CodeCounter {
    ...
    public static void main(String[] args) {
        ...
        String path = file.replace("D:\\JavaProgramingProjects\\JavaFundationalCodeStore\\java\\java_fundation\\src\\main\\java\\com\\example\\java\\classworkin2022\\documentationwriting\\work03\\CodeCounter","src");
        ArrayList<File> arrayList = getFile(new File(path));
        for (File f : arrayList) {
            //D:\JavaProgramingProjects\JavaFundationalCodeStore\java\java_fundation\src\main\java\com\example\java\classworkin2022\documentationwriting\work03
